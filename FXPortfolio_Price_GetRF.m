function FX_Portfolio = FXPortfolio_Price_GetRF(FX_Portfolio,workbookSheetNames,workbookDates,workbookCodes,workbookNumericData)
    ...
    for i =1:sizeFxPortfolio
        ...
        [ForeignPerDomesticFX_rates,dates] = returnColData(FX_Portfolio.exchaRateSheet,FX_Portfolio.Currencies(i).exchaRateCode,workbookSheetNames,workbookDates,workbookCodes,workbookNumericData);
